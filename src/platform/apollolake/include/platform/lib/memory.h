...
/* Heap section counts base, 64KB in total, for SKL/KBL */
...
#if HP_SRAM_SIZE >= 0x100000
/* maximum all SRAM banks used as runtime heap */
#define RT_COUNT_MAX	(HP_SRAM_SIZE / HEAP_RUNTIME_UNIT_SIZE)
#else
/* very limited SRAM on apollolake, less than half of SRAM banks used as runtime heap */
#define RT_COUNT_MAX	(HP_SRAM_SIZE / (HEAP_RUNTIME_UNIT_SIZE * 2))
#endif
...
/* very limited SRAM on apollolake, can't afford too much blocks for runtime_shared */
#define RT_SHARED_COUNT		1
